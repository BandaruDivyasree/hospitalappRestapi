...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handlePropertyNotFound(HospitalNotFoundException ex) {
        String message = ex.getMessage();
        HttpHeaders headers = new HttpHeaders();
        headers.add("desc", "Hospital not found");
        String path = "";
    ...
    public ResponseEntity<Object> handlePropertyNotFound(DoctorNotFoundException ex) {
        String message = ex.getMessage();
        HttpHeaders headers = new HttpHeaders();
        headers.add("desc", "Doctor not found");
        String path = "";
